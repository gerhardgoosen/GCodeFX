...
public class GCodeFXController implements Initializable {

	private static final Logger logger = Logger.getLogger(GCodeFXController.class.getName());
	...
	public void initialize(URL location, ResourceBundle resources) {
		print(Messages.GetBundle().getString("GCodeFXController.helloText"));
	...
	public void setStage(Stage stage) {
		...
		stage.setOnCloseRequest(e -> {
			try {
				print(Messages.GetBundle().getString("GCodeFXController.goodbyeText"));
